...
export default function Result() {
    ...
    const computerChoice = generateComputerChoice();
     ...
     switch (computerChoice) {
        case 'rock':
            computerClassString = 'bg-rock-2 w-[120px] h-[120px] icon rounded-full flex items-center justify-center border-[14px]  border-rock-2 shadow-rock absolute';
            computerImageUrl = '/images/icon-rock.svg';
            break;
        case 'paper':
            computerClassString = 'bg-paper-2 w-[120px] h-[120px] icon rounded-full flex items-center justify-center border-[14px] border-paper-2 shadow-paper absolute';
            computerImageUrl = '/images/icon-paper.svg';
            break;
        case 'scissors':
            computerClassString = 'bg-scissors-2 w-[120px] h-[120px]  icon rounded-full flex items-center justify-center border-[14px] border-scissors-2 shadow-scissors absolute';
